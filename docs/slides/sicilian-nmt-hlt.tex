  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item Still, NLLB-1.3B fine-tuned (\textbf{31.43}) already clears his published
...
\begin{frame}{Conclusion \& outlook}
  \begin{itemize}
    ...
    \item On our harder literary test set we go from BLEU \textbf{5.27} (floor) to \textbf{31.43}
